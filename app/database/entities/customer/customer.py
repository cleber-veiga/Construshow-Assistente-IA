...
from app.database.entities.customer.processing.search_customer_credit_limit import proc as search_customer_credit_limit
...
def distribute(query,domain, data_chat):
    ...
    if domain == 'search_customer_credit_limit':
        formatted_data_markdown = search_customer_credit_limit(query,data_chat)
